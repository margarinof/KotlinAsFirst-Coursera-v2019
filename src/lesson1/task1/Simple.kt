 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = ((deg * 3600) + (min * 60) + sec) * 0.00000484811
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = pow(1 + (percent / 100.0), 3.0) * initial
